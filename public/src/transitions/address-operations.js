...
const EXAMPLES = {
  ...
  addressCreateIdentity: ["import { IdentitySigner, PlatformAddressInput, PlatformAddressSigner } from '@dashevo/evo-sdk';", 'const inputs = [new PlatformAddressInput({ address: senderAddress, amount })];', 'const identitySigner = new IdentitySigner();', 'const addressSigner = new PlatformAddressSigner();', 'await sdk.addresses.createIdentity({ identity, inputs, identitySigner, addressSigner });'],
};
